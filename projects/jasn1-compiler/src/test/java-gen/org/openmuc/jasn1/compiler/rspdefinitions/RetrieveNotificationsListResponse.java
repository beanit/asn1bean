...
public class RetrieveNotificationsListResponse implements BerSerializable, BerType, Serializable {
	...
	public static class NotificationList implements BerSerializable, BerType, Serializable {
