...
public class ListNotificationResponse implements BerSerializable, BerType, Serializable {
	...
	public static class NotificationMetadataList implements BerSerializable, BerType, Serializable {
