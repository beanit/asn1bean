...
import com.beanit.jasn1.compiler.pedefinitions.Fcp;
import com.beanit.jasn1.compiler.pedefinitions.FileManagement;
import com.beanit.jasn1.compiler.pedefinitions.PEGenericFileManagement;
import com.beanit.jasn1.compiler.pedefinitions.PEHeader;
import com.beanit.jasn1.compiler.pedefinitions.PEPUKCodes;
import com.beanit.jasn1.compiler.pedefinitions.PUKConfiguration;
import com.beanit.jasn1.compiler.pedefinitions.PUKKeyReferenceValue;
import com.beanit.jasn1.compiler.pedefinitions.ProfileElement;
import com.beanit.jasn1.compiler.pedefinitions.ProfileHeader;
import com.beanit.jasn1.compiler.pedefinitions.ServicesList;
  ...
  public void header() throws Exception {
    ...
    String expected =
        "A0 48 80 01 02 81 01 00 82 1A 53494D616C6C69616E63652053616D706C652050726F66696C65 83 0A 89019990001234567893 A5 06 81 00 84 00 8B 00 A6 10 06 06 67810F010201 06 06 67810F010204"
            .replaceAll("\\s", "");
    assertEquals(expected, HexConverter.toShortHexString(code));
  }
