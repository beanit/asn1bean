...
public ASNLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("IDENTIFIER", this), new Integer(38));
	literals.put(new ANTLRHashString("PRESENT", this), new Integer(62));
	literals.put(new ANTLRHashString("CHOICE", this), new Integer(16));
	literals.put(new ANTLRHashString("TIME", this), new Integer(86));
	literals.put(new ANTLRHashString("END", this), new Integer(25));
	literals.put(new ANTLRHashString("PDV", this), new Integer(60));
	literals.put(new ANTLRHashString("INTERSECTION", this), new Integer(45));
	...
	literals.put(new ANTLRHashString("PrintableString", this), new Integer(63));
	...
	literals.put(new ANTLRHashString("SYNTAX", this), new Integer(72));
	literals.put(new ANTLRHashString("INSTANCE", this), new Integer(43));
	literals.put(new ANTLRHashString("DATE-TIME", this), new Integer(89));
	literals.put(new ANTLRHashString("ENUMERATED", this), new Integer(26));
	literals.put(new ANTLRHashString("NumericString", this), new Integer(52));
	literals.put(new ANTLRHashString("PLUSINFINITY", this), new Integer(61));
	literals.put(new ANTLRHashString("TAGS", this), new Integer(73));
	literals.put(new ANTLRHashString("DATE", this), new Integer(87));
	literals.put(new ANTLRHashString("UTF8String", this), new Integer(82));
	literals.put(new ANTLRHashString("FROM", this), new Integer(33));
	literals.put(new ANTLRHashString("NULL", this), new Integer(51));
	literals.put(new ANTLRHashString("REAL", this), new Integer(65));
	literals.put(new ANTLRHashString("GraphicString", this), new Integer(36));
	literals.put(new ANTLRHashString("UTCTime", this), new Integer(81));
	literals.put(new ANTLRHashString("UNION", this), new Integer(77));
	literals.put(new ANTLRHashString("AUTOMATIC", this), new Integer(8));
	literals.put(new ANTLRHashString("OPTIONAL", this), new Integer(58));
	literals.put(new ANTLRHashString("SET", this), new Integer(69));
	literals.put(new ANTLRHashString("ObjectDescriptor", this), new Integer(53));
	literals.put(new ANTLRHashString("WITH", this), new Integer(85));
	...
	literals.put(new ANTLRHashString("T61String", this), new Integer(76));
	literals.put(new ANTLRHashString("UNIQUE", this), new Integer(78));
	literals.put(new ANTLRHashString("VideotexString", this), new Integer(83));
	literals.put(new ANTLRHashString("BY", this), new Integer(14));
	literals.put(new ANTLRHashString("BASEDNUM", this), new Integer(9));
	literals.put(new ANTLRHashString("PRIVATE", this), new Integer(64));
	literals.put(new ANTLRHashString("ANY", this), new Integer(6));
	literals.put(new ANTLRHashString("DEFAULT", this), new Integer(21));
	literals.put(new ANTLRHashString("DURATION", this), new Integer(90));
	...
	literals.put(new ANTLRHashString("MIN", this), new Integer(50));
	literals.put(new ANTLRHashString("INCLUDES", this), new Integer(42));
	literals.put(new ANTLRHashString("RELATIVE", this), new Integer(66));
	...
	literals.put(new ANTLRHashString("IMPLIED", this), new Integer(40));
	literals.put(new ANTLRHashString("RESULT", this), new Integer(67));
	literals.put(new ANTLRHashString("VisibleString", this), new Integer(84));
	...
	literals.put(new ANTLRHashString("ISO646String", this), new Integer(46));
	literals.put(new ANTLRHashString("SIZE", this), new Integer(70));
	literals.put(new ANTLRHashString("EXTERNAL", this), new Integer(31));
	literals.put(new ANTLRHashString("ABSENT", this), new Integer(4));
	literals.put(new ANTLRHashString("TeletexString", this), new Integer(74));
	literals.put(new ANTLRHashString("PARAMETER", this), new Integer(59));
	literals.put(new ANTLRHashString("OID", this), new Integer(57));
	...
	literals.put(new ANTLRHashString("MAX", this), new Integer(48));
	literals.put(new ANTLRHashString("MINUSINFINITY", this), new Integer(49));
	literals.put(new ANTLRHashString("GeneralString", this), new Integer(35));
	literals.put(new ANTLRHashString("LINKED", this), new Integer(47));
	literals.put(new ANTLRHashString("IMPORTS", this), new Integer(41));
	literals.put(new ANTLRHashString("UNIVERSAL", this), new Integer(79));
	literals.put(new ANTLRHashString("OCTET", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("TIME-OF-DAY", this), new Integer(88));
	literals.put(new ANTLRHashString("TRUE", this), new Integer(75));
	literals.put(new ANTLRHashString("SEQUENCE", this), new Integer(68));
	literals.put(new ANTLRHashString("UniversalString", this), new Integer(80));
	literals.put(new ANTLRHashString("IMPLICIT", this), new Integer(39));
	literals.put(new ANTLRHashString("INTEGER", this), new Integer(44));
...
inputState.guessing--;
	...
	private static final long[] mk_tokenSet_8() {
		long[] data = { 287984085547089920L, 137438953504L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_10() {
		long[] data = { 288054454291267584L, 137438953504L, 0L, 0L, 0L};
		return data;
	}
