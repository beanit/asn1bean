...
public ASNLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("ERRORS", this), new Integer(28));
	...
	literals.put(new ANTLRHashString("GraphicString", this), new Integer(38));
	...
	literals.put(new ANTLRHashString("EXPORTS", this), new Integer(31));
	literals.put(new ANTLRHashString("FALSE", this), new Integer(34));
	literals.put(new ANTLRHashString("GeneralizedTime", this), new Integer(36));
	...
	literals.put(new ANTLRHashString("ERROR", this), new Integer(27));
	literals.put(new ANTLRHashString("SIZE", this), new Integer(72));
	literals.put(new ANTLRHashString("EXTERNAL", this), new Integer(33));
	...
	literals.put(new ANTLRHashString("EXCEPT", this), new Integer(29));
	...
	literals.put(new ANTLRHashString("GeneralString", this), new Integer(37));
	...
	literals.put(new ANTLRHashString("EXTENSIBILITY", this), new Integer(32));
	literals.put(new ANTLRHashString("EXPLICIT", this), new Integer(30));
}
