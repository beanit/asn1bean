...
package com.beanit.asn1bean.compiler.extension_test.extensible;
...
public class ExtensibleSequenceAndMore implements BerType, Serializable {
	...
	private ExtensibleSequence extensibleSequence = null;
	private BerVisibleString more = null;
	
	public ExtensibleSequenceAndMore() {
	}

	public ExtensibleSequenceAndMore(byte[] code) {
		this.code = code;
	}

	public void setExtensibleSequence(ExtensibleSequence extensibleSequence) {
		this.extensibleSequence = extensibleSequence;
	}

	public ExtensibleSequence getExtensibleSequence() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(ExtensibleSequence.tag)) {
			extensibleSequence = new ExtensibleSequence();
