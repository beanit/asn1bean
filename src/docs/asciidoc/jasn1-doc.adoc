...
The generated Java classes may be put under a license of your choice.
...
The generated classes can then be used to easily encode and decode
BER/DER encoded data. For an example on how to use the generated
classes see the folder
